...
const TRANSLATIONS = {
  en: {
    ...
    'nav.downloader': 'Video Downloader',
    'downloader.badge': '🎥 HD Quality · Fast · Unlimited',
    'downloader.title': 'Threads Video Downloader',
    'downloader.subtitle': 'Paste the Threads post link below to download your favorite videos directly to your device.',
    'downloader.cta': 'Load Video',
    'downloader.inputHelp': 'Works with any public Threads post containing a video.',
    'downloader.loading': 'Retrieving video files from Threads...',
    'downloader.downloadBtn': 'Download',
    'downloader.newBtn': 'Download Another',
    'downloader.qualityLabel': 'Select the quality you want:',
    'downloader.qualityHD': 'High Quality (HD)',
    'downloader.qualitySD': 'Standard Quality (SD)',
    'downloader.guideTitle': 'How to Download Threads Videos',
    'downloader.step1': 'Paste the post link in the "Tautan Utas" field.',
    'downloader.step2': 'Tap "Muat Video".',
    'downloader.step3': 'Choose your desired quality and tap "Unduh". On iOS, the share menu will appear (tap "Save Video"). On Android, it downloads automatically.',
    'downloader.faqTitle': 'Frequently Asked Questions',
    'downloader.faqQ1': 'Is it safe and anonymous?',
    'downloader.faqA1': 'Yes! We do not require any login credentials, passwords, or personal details. The video is downloaded directly via our secure proxy servers.',
    'downloader.faqQ2': 'Why can\'t I download videos from private accounts?',
    'downloader.faqA2': 'Our downloader can only access public posts. Private accounts block external data fetching to protect user privacy.',
    'downloader.faqQ3': 'What format are the videos saved in?',
    'downloader.faqA3': 'Videos are downloaded in high-definition MP4 format, compatible with all modern smartphones, tablets, and desktop computers.',
    'faq': [
  ...
  id: {
    ...
    'nav.downloader': 'Pengunduh Video',
    'downloader.badge': '🎥 Kualitas HD · Cepat · Tanpa Batas',
    'downloader.title': 'Pengunduh Video Threads',
    'downloader.subtitle': 'Tempel tautan postingan Threads di bawah untuk mengunduh video favorit Anda langsung ke perangkat Anda.',
    'downloader.cta': 'Muat Video',
    'downloader.inputHelp': 'Bekerja dengan postingan publik Threads apa pun yang berisi video.',
    'downloader.loading': 'Mengambil file video dari Threads...',
    'downloader.downloadBtn': 'Unduh',
    'downloader.newBtn': 'Unduh Lainnya',
    'downloader.qualityLabel': 'Pilih kualitas yang Anda inginkan:',
    'downloader.qualityHD': 'Kualitas Tinggi (HD)',
    'downloader.qualitySD': 'Kualitas Standar (SD)',
    'downloader.guideTitle': 'Cara Mengunduh Video Threads',
    'downloader.step1': 'Tempelkan tautan kiriman di bidang "Tautan Utas".',
    'downloader.step2': 'Ketuk "Muat Video".',
    'downloader.step3': 'Pilih kualitas yang Anda inginkan dan ketuk tombol "Unduh". Jika menggunakan iOS, menu berbagi akan muncul (klik "Simpan Video"). Di Android, file terunduh otomatis.',
    'downloader.faqTitle': 'Pertanyaan yang Sering Diajukan (FAQ)',
    'downloader.faqQ1': 'Apakah aman dan anonim?',
    'downloader.faqA1': 'Ya! Kami tidak memerlukan kredensial login, kata sandi, atau detail pribadi apa pun. Video diunduh langsung melalui server proxy kami yang aman.',
    'downloader.faqQ2': 'Mengapa saya tidak bisa mengunduh video dari akun privat?',
    'downloader.faqA2': 'Pengunduh kami hanya dapat mengakses postingan publik. Akun privat memblokir pengambilan data eksternal untuk melindungi privasi pengguna.',
    'downloader.faqQ3': 'Format apa yang digunakan untuk menyimpan video?',
    'downloader.faqA3': 'Video diunduh dalam format MP4 resolusi tinggi, kompatibel dengan semua ponsel cerdas, tablet, dan komputer modern.',
    'faq': [
